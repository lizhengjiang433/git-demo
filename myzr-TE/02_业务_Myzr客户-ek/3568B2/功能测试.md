...
![image-20260710140921228](功能测试.assets/image-20260710140921228.png)
...
```bash
wpa_passphrase LZJ 8888888 > /etc/wpa_supplicant.conf

wpa_passphrase MYZR-D303-WiFi8-2.4G Myzr2012 > /etc/wpa_supplicant.conf

...
- sudo nmcli device wifi connect LZJ password 20021225aa ifname wlx94ba06f285ef


公司WiFi：MYZR-D303-WiFi6		密码：Myzr2012

|          | 电脑端IPV4      | 开发板          |
| -------- | --------------- | --------------- |
| 公司WiFi | 192.168.1.223   | 192.168.1.20    |
| LZJ      | 192.168.243.237 | 192.168.243.186 |

nmcli**：Linux 系统自带的**网络管理工具**（比 wpa_supplicant 简单 ）
...
#重新连接你的手机热点
sudo nmcli device wifi connect "你的手机热点名" password "热点密码" ifname wlan0
```
...
wpa_passphrase LZJ 20021225aa > /etc/wpa_supplicant.conf
权限问题
sudo sh -c "wpa_passphrase LZJ 20021225aa > /etc/wpa_supplicant.conf"

![本地回环网卡](picture/本地回环网卡.png)

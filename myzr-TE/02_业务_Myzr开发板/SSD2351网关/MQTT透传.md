...
![串口列表配置](MQTT透传.assets/串口列表配置.png)

## 3.**MQTT列表配置**

![MQTT列表配置](MQTT透传.assets/MQTT列表配置.png)

# 四、串口调试工具配置

波特率115200，接收和发送端都设置文本格式为HEX

![串口调试工具配置](MQTT透传.assets/串口调试工具配置.png)
...
![上行透传串口调试窗口](MQTT透传.assets/上行透传串口调试窗口.png)



![上行透传MQTTX](MQTT透传.assets/上行透传MQTTX.png)
...
![下行透传MQTTX](MQTT透传.assets\下行透传MQTTX.png)
...
![下行透传串口调试窗口](MQTT透传.assets/下行透传串口调试窗口.png)
